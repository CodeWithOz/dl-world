...
export const BUILDINGS: BuildingDef[] = [
  ...
  // ============================================================ the frontier
  // Across the river: datasets that aren't images. Recommendations,
  // tables, text — same engine, same SGD, new shapes of data.
  {
    id: "gym",
    name: "Refinement Gym",
    district: "Refinement Row",
    tour: 16,
    icon: "🏋",
    x: 42, y: 44, w: 8, h: 6,
    color: "#e0a06a", roof: "#a86a2f",
    trainer: "refinery",
    blurb: "Squeeze more accuracy from the same network: normalize inputs, smooth labels, mix up images — and race a plain twin.",
    interior: room(18, 10, [
      { id: "gym.bench", name: "Twin Race Bench", icon: "🎛" },
      { id: "gym.norm", name: "Normalization Bar", icon: "⚖️" },
      { id: "gym.smooth", name: "Label-Smoothing Bench", icon: "🧈" },
      { id: "gym.mixup", name: "Mixup Blender", icon: "🥤" },
      { id: "gym.tta", name: "TTA Mirror Hall", icon: "🪞" },
    ]),
  },
  {
    id: "cinema",
    name: "Taste Cinema",
    district: "Taste Quarter",
    tour: 17,
    icon: "🎬",
    x: 22, y: 44, w: 8, h: 6,
    color: "#c98fd9", roof: "#8f5aa6",
    trainer: "cinema",
    blurb: "Collaborative filtering: no pixels at all — learn what 40 movie-goers like from their ratings alone, via embeddings.",
    interior: room(18, 10, [
      { id: "cinema.ratings", name: "The Ratings Wall", icon: "🌟" },
      { id: "cinema.bench", name: "Training Bench", icon: "🎛" },
      { id: "cinema.dot", name: "Dot-Product Desk", icon: "✖️" },
      { id: "cinema.factors", name: "Factor Projector", icon: "🗺" },
    ]),
  },
  {
    id: "arbor",
    name: "Decision Arboretum",
    district: "Table Grove",
    tour: 18,
    icon: "🌳",
    x: 6, y: 44, w: 8, h: 6,
    color: "#9bc46f", roof: "#5f8a3c",
    trainer: null,
    blurb: "Tabular data needs no gradients: grow a decision tree one question at a time, then a whole forest of them.",
    interior: room(18, 10, [
      { id: "arbor.split", name: "The First Question", icon: "❓" },
      { id: "arbor.tree", name: "The Grown Tree", icon: "🌳" },
      { id: "arbor.forest", name: "Forest Lookout", icon: "🌲" },
    ]),
  },
  {
    id: "tokenmill",
    ...
    trainer: "sentiment",
    blurb: "Text can't enter a matmul. The mill turns raw sentences into tokens, tokens into numbers — watch the whole pipeline.",
    interior: room(18, 10, [
      { id: "tokenmill.split", name: "The Token Splitter", icon: "✂️" },
      { id: "tokenmill.vocab", name: "The Vocab Wall", icon: "📚" },
      { id: "tokenmill.numeric", name: "The Numericalizer", icon: "🔢" },
    ]),
  },
  {
    id: "sentstudio",
    name: "Sentiment Studio",
    district: "Language Lane",
    tour: 20,
    icon: "🎭",
    ...
    interior: room(18, 10, [
      { id: "sentstudio.bench", name: "Training Bench", icon: "🎛" },
      { id: "sentstudio.reader", name: "The Review Reader", icon: "🎭" },
      { id: "sentstudio.weights", name: "Word-Weight Wall", icon: "⚖️" },
    ]),
  },
  {
    id: "echo",
    name: "Echo Tower",
    district: "Sequence Summit",
    tour: 21,
    icon: "🗣",
    x: 44, y: 55, w: 7, h: 6,
    color: "#8f9bd9", roof: "#5a64a6",
    trainer: "echo",
    blurb: "A language model from scratch: read three words, predict the fourth — next-word prediction in miniature.",
    interior: room(18, 10, [
      { id: "echo.corpus", name: "The Counting Corpus", icon: "🔡" },
      { id: "echo.loop", name: "The Loop Room", icon: "🔁" },
      { id: "echo.next", name: "Next-Word Desk", icon: "🔮" },
